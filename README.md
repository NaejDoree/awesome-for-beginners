...
- [Godot Engine](https://github.com/godotengine/godot/issues?q=label%3AHacktoberfest) _(label: Hacktoberfest)_ <br> 2D and 3D cross-platform game engine. Also has C# and Python code.
